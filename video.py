...
def app():
    ...
    uploaded_files = st.file_uploader("動画を選択（複数可）", type=["mp4", "mov", "avi"], accept_multiple_files=True)
    ...
    if uploaded_files:
        ...
        if st.button("投稿する"):
            ...
            save_post(st.session_state["username"], saved_files, comment, public, "video")
